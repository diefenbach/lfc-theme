...
Change: cache keys are using CACHE_MIDDLEWARE_PREFIX now
Bugfix  lfc_theme_tags: added missing import of settings
...
* Added login link
* Improved management interface within content view
* Bugfix: transitions
* Bugfix: Using correct language for logo link
...
* Some refactoring accordign to LFC 1.0 alpha 6
